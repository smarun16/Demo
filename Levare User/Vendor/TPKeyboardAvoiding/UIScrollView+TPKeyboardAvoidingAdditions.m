...
- (void)TPKeyboardAvoiding_findTextFieldAfterTextField:(UIView*)priorTextField beneathView:(UIView*)view minY:(CGFloat*)minY foundView:(UIView* __autoreleasing *)foundView {
    ...
    for ( UIView *childView in view.subviews ) {
        ...
        if ( ([childView isKindOfClass:[UITextField class]] || [childView isKindOfClass:[UITextView class]]) && childView.isUserInteractionEnabled && ((UITextField*)childView).isEnabled) {
...
- (void)TPKeyboardAvoiding_initializeView:(UIView*)view {
    if ( [view isKindOfClass:[UITextField class]]
        ...
        /*if (((UITextField*)view).returnKeyType == UIReturnKeyDefault &&otherView ) {
