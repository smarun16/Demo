...
- (void)defalutInit
{
    ...
    _titleView.font = [SESSION getColorValue] ? [UIFont boldSystemFontOfSize:14.0f] : [UIFont systemFontOfSize:14.0f];
    _titleView.backgroundColor = [SESSION getColorValue] ? [UIColor whiteColor] : [HELPER getColorFromHexaDecimal:COLOR_APP_PRIMARY];
    
    _titleView.textAlignment = NSTextAlignmentCenter;
    _titleView.textColor = [SESSION getColorValue] ? [UIColor blackColor] : [UIColor whiteColor];
    CGFloat xWidth = self.bounds.size.width;
    _titleView.lineBreakMode = NSLineBreakByTruncatingTail;
    _titleView.frame = CGRectMake(0, 0, xWidth, 35.0f);
