...
static const CGFloat kDGActivityIndicatorDefaultSize = 100.0f;
...
- (void)setupAnimation {
    ...
    if ([animation respondsToSelector:@selector(setupAnimationInLayer:withSize:tintColor:)]) {
        [animation setupAnimationInLayer:_myLoadingView.layer withSize:CGSizeMake(_size, _size) tintColor:_tintColor];
